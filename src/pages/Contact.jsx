...
const Contact = () => {
  const handleSubmit = (e) => {
    ...
    const text = `Hello Shutter School!
My name is ${firstName} ${lastName}.
Email: ${email}
Phone: ${phone || 'Not provided'}
Interested In: ${course || 'Not specified'}

Message:
${message}`;

    const whatsappUrl = `https://wa.me/919619998833?text=${encodeURIComponent(text)}`;
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select name="course" className="w-full bg-[#111] border border-gray-800 px-4 h-12 text-sm text-gray-300 focus:outline-none focus:border-gray-500 transition-colors rounded-sm appearance-none cursor-pointer">
          ...
          >
            ...
            <div className="mt-12 pt-8 border-t border-gray-900">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/shutterschoolmumbai?igsh=NmVwODhhZ3UxcG9z" target="_blank" rel="noopener noreferrer" className="bg-[#111] p-3 rounded-sm border border-gray-900 text-gray-400 hover:text-white transition">
                ...
                <a href="https://www.facebook.com/share/1CcWQ5fv5d/" target="_blank" rel="noopener noreferrer" className="bg-[#111] p-3 rounded-sm border border-gray-900 text-gray-400 hover:text-white transition">
