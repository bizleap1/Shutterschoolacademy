  ...
  return (
    <footer className="bg-[#080808] text-[#F7F7F7] pt-20 pb-10 border-t border-[#3A3A3A]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 mb-12 md:mb-20 font-manrope">
          
          <div className="col-span-1 md:col-span-12 lg:col-span-4 pr-0 lg:pr-10">
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-2">
            <h3 className="text-sm font-spartan font-bold mb-8 tracking-widest uppercase text-[#777777]">Quick Links</h3>
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-3">
            <h3 className="text-sm font-spartan font-bold mb-8 tracking-widest uppercase text-[#777777]">Courses</h3>
            <ul className="space-y-6">
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-3">
            <h3 className="text-sm font-spartan font-bold mb-8 tracking-widest uppercase text-[#777777]">Contact Us</h3>
            <ul className="space-y-6 text-[15px] font-medium text-[#F7F7F7]">
              <li>+91 9619994477</li>
              <li>+91 9619994466</li>
              <li>
                <a href="mailto:shutterschoolindia@gmail.com" className="hover:text-[#B8B8B8] transition-colors tracking-wide">shutterschoolindia@gmail.com</a>
              </li>
        ...
        <div className="pt-8 border-t border-[#3A3A3A] flex flex-col md:flex-row justify-between items-center text-sm text-[#888888] font-manrope font-medium tracking-wide">
