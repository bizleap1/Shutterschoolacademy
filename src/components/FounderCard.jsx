    ...
    >
      ...
      <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
        ...
        <div className="flex gap-4 mt-auto">
           <a href="#" className="text-[#B8B8B8] hover:text-[#F7F7F7] transition-colors">
           ...
           <a href="#" className="text-[#B8B8B8] hover:text-[#F7F7F7] transition-colors"><Mail className="w-4 h-4" /></a>
        </div>
        <div className="flex gap-4 mt-auto">
           <a href="#" className="text-[#555555] hover:text-[#B8B8B8] transition-colors">
