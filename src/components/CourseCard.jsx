...
const CourseCard = ({ course, index, onClick }) => {
  return (
    ...
    >
      <div 
        className="aspect-[4/3] w-full bg-black relative overflow-hidden flex items-center justify-center cursor-pointer"
      ...
      <div className="p-6 md:p-8 flex flex-col flex-grow relative">
        ...
        <h3 
          className="text-xl font-heading font-black uppercase tracking-wider mb-2 text-[#111111] cursor-pointer hover:text-gray-600 transition-colors"
          onClick={() => onClick && onClick()}
        >
          {course.title}
        </h3>
